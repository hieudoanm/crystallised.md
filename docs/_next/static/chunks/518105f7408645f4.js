(globalThis.TURBOPACK || (globalThis.TURBOPACK = [])).push([
				...
				!(function e(t, n, r, i, a) {
					...
					if (E(t))
						...
						for (t = m.call(t), m = 0; !(i = t.next()).done; )
							((f = p + M((i = i.value), m++)), (d += e(i, n, r, f, a)));
					else if ('object' === f) {
				...
				children: [
					(0, t.jsx)(a.default, {
						children: (0, t.jsx)('title', {
							children: ''.concat(n.APP_NAME, ' - Crystallised Knowledge'),
						}),
					}),
					(0, t.jsx)('div', {
	...
	(e) => {
		e.v((t) =>
			Promise.all(
				['static/chunks/e6153f92686bf758.js'].map((t) => e.l(t)),
			).then(() => t(3933)),
		);
	},
	6376,
