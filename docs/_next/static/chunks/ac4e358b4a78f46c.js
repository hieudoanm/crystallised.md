(globalThis.TURBOPACK || (globalThis.TURBOPACK = [])).push([
	...
	(e, t, r) => {
		...
		((u.ab =
			'/ROOT/node_modules/.pnpm/next@16.0.1_@babel+core@7.28.4_react-dom@19.2.0_react@19.2.0__react@19.2.0/node_modules/next/dist/compiled/process/'),
			(t.exports = u(229)));
	},
	4140,
	(e, t, r) => {
	...
	(e, t, r) => {
		...
		var w = (E.prototype = new j());
		((w.constructor = E), v(w, g.prototype), (w.isPureReactComponent = !0));
		var O = Array.isArray;
		function x() {}
	...
	(e, t, r) => {
		...
		let j = c.default.forwardRef(function (e, t) {
				let r,
					n,
					{
						href: o,
				...
				let M = c.default.useContext(d.RouterContext),
					N = !1 !== v,
					{ href: $, as: H } = c.default.useMemo(() => {
						if (!M) {
							let e = g(o);
							return { href: e, as: u ? g(u) : e };
						}
				...
				let A = C ? n && 'object' == typeof n && n.ref : t,
					...
					z = (0, m.useMergedRef)(B, A);
				c.default.useEffect(() => {
					!M || (D && N && _(M, $, H, { locale: x }));
				}, [H, $, D, x, N, M?.locale, M]);
				let V = {
					ref: z,
					onClick(e) {
				...
				if ((0, f.isAbsoluteUrl)(H)) V.href = H;
					...
					let e = void 0 !== x ? x : M?.locale;
					V.href =
						(M?.isLocaleDomain &&
							(0, h.getDomainLocale)(H, e, M?.locales, M?.domainLocales)) ||
						(0, b.addBasePath)((0, p.addLocale)(H, e, M?.defaultLocale));
				}
				return C
					? c.default.cloneElement(n, V)
					: (0, i.jsx)('a', { ...R, ...V, children: r });
			}),
			E = (0, c.createContext)({ pending: !1 }),
			w = () => (0, c.useContext)(E),
			O = j;
		('function' == typeof r.default ||
			('object' == typeof r.default && null !== r.default)) &&
							...
							children: [
								...
								(0, t.jsx)(r.default, {
									...
									children: (0, t.jsx)('button', {
										type: 'button',
										className:
											'btn btn-primary w-full rounded border border-neutral-800 py-4 uppercase',
	...
	(e, t, r) => {
		let n = '/404';
		((window.__NEXT_P = window.__NEXT_P || []).push([n, () => e.r(3059)]),
			t.hot &&
	...
	(e) => {
		e.v((t) =>
			Promise.all(
				['static/chunks/eac17f1beee7ab52.js'].map((t) => e.l(t)),
			).then(() => t(2643)),
		);
	},
	8118,
	(e) => {
		e.v((t) =>
			Promise.all(
				['static/chunks/aec56187daf7c00f.js'].map((t) => e.l(t)),
			).then(() => t(129)),
		);
	},
]);
