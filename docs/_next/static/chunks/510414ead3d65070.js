(globalThis.TURBOPACK || (globalThis.TURBOPACK = [])).push([
	...
	(e, t, n) => {
		...
		((S.constructor = E), _(S, b.prototype), (S.isPureReactComponent = !0));
		var x = Array.isArray;
		function k() {}
							...
							case 'object':
								switch (t.$$typeof) {
									...
									case i:
										...
										break;
									case y:
										return e((d = t._init)(t._payload), n, r, u, a);
								}
						}
					if (d)
						return (
...
X^2^`;
	...
	(e) => {
		...
		null != i.default.variable && (u.variable = i.default.variable);
		var a = e.i(9813);
		e.s(
			[
				'default',
	...
	(e) => {
		e.v((t) =>
			Promise.all(
				['static/chunks/89254a5456e25420.js'].map((t) => e.l(t)),
			).then(() => t(2643)),
		);
	},
	8118,
