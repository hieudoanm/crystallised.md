	...
	(e, t, r) => {
		...
		let _ = u.default.forwardRef(function (e, t) {
				...
				let $ = C ? n && 'object' == typeof n && n.ref : t,
					[U, D, F] = (0, d.useIntersection)({ rootMargin: '200px' }),
					B = u.default.useCallback(
						(e) => {
							((L.current !== A || I.current !== H) &&
								(F(), (L.current = A), (I.current = H)),
								U(e));
						},
						[A, H, F, U],
					),
					z = (0, h.useMergedRef)(B, $);
				u.default.useEffect(() => {
					M && D && N && m(M, H, A, { locale: x });
				}, [A, H, D, x, N, null == M ? void 0 : M.locale, M]);
				let V = {
					ref: z,
					onClick(e) {
				...
				if ((0, a.isAbsoluteUrl)(A)) V.href = A;
					...
					V.href =
						...
						(0, y.addBasePath)(
							(0, s.addLocale)(A, e, null == M ? void 0 : M.defaultLocale),
						);
				}
				return C
