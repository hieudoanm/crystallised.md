(globalThis.TURBOPACK || (globalThis.TURBOPACK = [])).push([
	...
	(e, t, n) => {
		...
		async function q(t) {
			...
			if (
				...
				let { initScriptLoader: t } = e.r(7443);
				t(a.scriptLoader);
			}
					...
					.then((r) => {
						...
						return (null == s ? void 0 : s.Component) === a
							? e
									.A(5923)
									.then((r) =>
										e.A(6376).then((e) => ((t.App = n = e.default), r)),
									)
	...
	(e, t, n) => {
		'use strict';
		(Object.defineProperty(n, '__esModule', { value: !0 }), e.r(5627));
		let r = e.r(8759),
			a = e.r(8923);
		((window.next = {
			version: r.version,
