(globalThis.TURBOPACK || (globalThis.TURBOPACK = [])).push([
	...
	(e, t, n) => {
		...
		async function q(t) {
			...
			if (
				...
				let { initScriptLoader: t } = e.r(424);
				t(a.scriptLoader);
			}
					...
					.then((r) => {
						...
						return (null == s ? void 0 : s.Component) === a
							? e
									.A(8858)
									.then((r) =>
										e.A(3489).then((e) => ((t.App = n = e.default), r)),
									)
	...
	(e, t, n) => {
		'use strict';
		(Object.defineProperty(n, '__esModule', { value: !0 }), e.r(9598));
		let r = e.r(9971),
			a = e.r(6127);
		((window.next = {
			version: r.version,
